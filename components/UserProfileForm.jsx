              ...
              <div className="mb-5 w-full sm:w-2/12 ltr:sm:mr-4 rtl:sm:ml-4">
                <label htmlFor="avatarInput">
                  <img
                    ...
                    alt="avatar"
                    className="mx-auto h-20 w-20 rounded-full object-cover md:h-32 md:w-32 cursor-pointer"
                  />
                </label>
              ...
              <div className="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <PhoneInput
                    ...
                    // react-phone-input-2 expects digits only; we convert from E.164
                    value={e164ToDigits(profile.phone)}
                    onChange={(digits /*, countryData, event, formatted */) => {
                      const e164 = digitsToE164(digits);
                      handleProfileChange('phone', e164);
                    }}
                    // styling
                    inputProps={{
                      name: 'phone',
...
<div className="sm:hidden my-3 rounded-md bg-gray-100 dark:bg-gray-800 p-3 text-xs leading-relaxed text-gray-700 dark:text-gray-300">
  ...
  <p className="my-2">
    ...
    <a href="tel:+919266683106" className="underline">9266683106</a>
      ...
      {activeTab === 'company' && (
        <form
          className="panel max-w-full rounded-md border border-[#ebedf2] bg-white p-6 dark:border-[#191e3a] dark:bg-black"
          onSubmit={(e) => e.preventDefault()}
        >
          ...
          <div className="mb-6">
            ...
            >
              {logoPreview ? (
                ...
                <span className="text-xs text-[#94a3b8]">Add Logo</span>
              )}
            </label>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            {/* phone1 */}
            <div>
              <label htmlFor="phone1">Primary Phone (E.164)</label>
              <PhoneInput
                id="phone1"
                country="in"
                enableSearch
                ...
                inputProps={{ name: 'phone1', autoComplete: 'tel', placeholder: 'e.g., +91 98765 43210' }}
                inputClass={`form-input ${companyErrors.phone1 ? '!border-red-500' : ''}`}
              />
            ...
            {/* phone2 */}
            <div>
              <label htmlFor="phone2">Secondary Phone (E.164)</label>
              <PhoneInput
                id="phone2"
                country="in"
                enableSearch
                ...
                inputProps={{ name: 'phone2', autoComplete: 'tel', placeholder: 'e.g., +91 91234 56789' }}
                inputClass={`form-input ${companyErrors.phone2 ? '!border-red-500' : ''}`}
              />
