...
export default function EnhancedFormBuilder() {
    ...
    const addCustomDesignedField = () => {
        ...
        const fieldName = customFieldLabel
            .trim()
            .toLowerCase()
            .replace(/\s+/g, '_')
            .replace(/[^\w_]/gi, '');
        ...
        if (styles.inputStyle === 'underline') {
            return (
                <input
                    ...
                    required={required}
                    className={`${baseClasses} border-b border-gray-300 focus:border-indigo-500 outline-none py-1.5 px-0.5`}
                />
            );
        } else {
            // box style
            ...
            return (
                <input
                    ...
                    placeholder={placeholder}
                    required={required}
                    className={`${baseClasses} border border-gray-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none px-3 py-2 ${radiusClass} bg-white`}
                />
            );
        }
    };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-screen-xl mx-auto">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="p-5 border rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                            ...
                            <>
                                ...
                                <ul className="space-y-2">
                                    {selectedAdditionalFields.map((field, idx) => (
                                        <li
                                            key={`add-${idx}`}
                                            className="flex items-center justify-between gap-3 p-3 bg-white dark:bg-gray-750 rounded border border-gray-200 dark:border-gray-600 group"
                                        >
                                            <div className="flex items-center gap-2">
                                                ...
                                                {field.isCustom && (
                                                    <span className="ml-2 text-xs text-indigo-500 bg-indigo-100 dark:bg-indigo-900 dark:text-indigo-300 px-1.5 py-0.5 rounded-full">Custom</span>
                                                )}
                        ...
                        {selectedAdditionalFields.length === 0 && <p className="text-sm text-gray-400 dark:text-gray-500 text-center mt-4">Add pre-made or custom fields to your form.</p>}
                    </div>
                </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <div className="flex gap-2">
                                    {['underline', 'box'].map((style) => (
                                        <button
                                            key={style}
                                            onClick={() => setStyles({ ...styles, inputStyle: style })}
                                            className={`px-3 py-1.5 border rounded-md text-sm capitalize ${styles.inputStyle === style ? 'bg-indigo-100 border-indigo-400 text-indigo-700 dark:bg-indigo-700 dark:border-indigo-500 dark:text-white' : 'border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                                        >
                                            {style}
                                        </button>
                                    ))}
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    {['filled', 'outline'].map((style) => (
                                        <button
                                            key={style}
                                            onClick={() => setStyles({ ...styles, buttonStyle: style })}
                                            className={`px-3 py-1.5 border rounded-md text-sm capitalize ${styles.buttonStyle === style ? 'bg-indigo-100 border-indigo-400 text-indigo-700 dark:bg-indigo-700 dark:border-indigo-500 dark:text-white' : 'border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                                        >
                                            {style}
                                        </button>
                                    ))}
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    {['none', 'small', 'medium', 'large'].map((radius) => (
                                        <button
                                            key={radius}
                                            onClick={() => setStyles({ ...styles, roundedCorners: radius })}
                                            className={`px-3 py-1.5 border rounded-md text-sm capitalize ${styles.roundedCorners === radius ? 'bg-indigo-100 border-indigo-400 text-indigo-700 dark:bg-indigo-700 dark:border-indigo-500 dark:text-white' : 'border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'}`}
                                        >
                                            {radius}
                                        </button>
                                    ))}
                            ...
                            <div className="grid grid-cols-2 gap-x-4 gap-y-3 pt-2">
                                <div>
                                    ...
                                    <input
                                        type="color"
                                        value={styles.formBackgroundColor}
                                        onChange={(e) => setStyles({ ...styles, formBackgroundColor: e.target.value })}
                                        className="w-full h-9 border border-gray-300 dark:border-gray-600 rounded cursor-pointer p-0.5"
                                    />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStyles({ ...styles, buttonBackgroundColor: e.target.value })}
                                        className="w-full h-9 border border-gray-300 dark:border-gray-600 rounded cursor-pointer p-0.5"
                                    />
                                </div>
                                <div>
                    ...
                    <div className="p-5 border rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                        ...
                        <textarea
                            ...
                            className="hidden md:block w-full h-48 p-3 border border-gray-300 dark:border-gray-600 rounded-md font-mono text-xs bg-gray-50 dark:bg-gray-700 dark:text-gray-300 resize-none focus:outline-none focus:ring-1 focus:ring-indigo-500"
                        />
                        <button
